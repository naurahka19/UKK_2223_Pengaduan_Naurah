    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
       ...
       <i class="fa fa-street-view" aria-hidden="true"></i>
        ...
        <div class="sidebar-brand-text mx-3">DUMASLapor<span>!</span> <br> Masyarakat</div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h3>Aplikasi Pengaduan Masyarakat Online</h3>
          
           <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <h5 class="mr-2 d-none d-lg-inline text-dark" style="margin-left: 780px;" style="margin-top: 50px;"><?= $_SESSION['nama'] ?></h5>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright by Naurah Kamilia</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
